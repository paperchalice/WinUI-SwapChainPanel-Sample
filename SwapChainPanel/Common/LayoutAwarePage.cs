...
namespace SwapChainPanel.Common
{
    /// <summary>
    ...
    /// </list>
    /// </summary>
    internal class LayoutAwarePage : Page
    {
        /// <summary>
        ...
        public LayoutAwarePage()
        {
            ...
            Loaded += (sender, e) =>
            {
                ...
                )
                {
                    ...
                    //App.MainWindow.CoreWindow.Dispatcher.AcceleratorKeyActivated +=
        ...
        {
            get => (IObservableMap<string, object>)GetValue(DefaultViewModelProperty);
        ...
        //        bool controlKey =
        //            (coreWindow.GetKeyState(VirtualKey.Control) & downState) == downState;
        ...
        public void StartLayoutUpdates(object sender, RoutedEventArgs e)
        {
            ...
            VisualStateManager.GoToState(
                control,
                DetermineVisualState(Window.Current.Bounds.Width),
                false
            );
        }
        ...
        private class ObservableDictionary<K, V> : IObservableMap<K, V>
        {
            ...
            public bool Remove(KeyValuePair<K, V> item)
            {
                V currentValue;
                if (
                    _dictionary.TryGetValue(item.Key, out currentValue)
